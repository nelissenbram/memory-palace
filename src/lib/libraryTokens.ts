...
export const DANGER = "#A6432E";          // warm on-brand destructive (delete / disconnect / error toast)
export const DANGER_SOFT = "#EFD3D3";     // danger hairline / soft edge tint on light
