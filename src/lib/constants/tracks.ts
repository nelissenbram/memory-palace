...
export const TRACKS: Track[] = [
  // ─── Track 1: Preserve Past & New Data (5.1.1) ───
  {
    ...
    steps: [
      { id: "p_first_photo", titleKey: "tracks.preserve.p_first_photo.title", descriptionKey: "tracks.preserve.p_first_photo.desc", hintKey: "tracks.preserve.p_first_photo.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_10_photos", titleKey: "tracks.preserve.p_10_photos.title", descriptionKey: "tracks.preserve.p_10_photos.desc", hintKey: "tracks.preserve.p_10_photos.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_50_photos", titleKey: "tracks.preserve.p_50_photos.title", descriptionKey: "tracks.preserve.p_50_photos.desc", hintKey: "tracks.preserve.p_50_photos.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_100_photos", titleKey: "tracks.preserve.p_100_photos.title", descriptionKey: "tracks.preserve.p_100_photos.desc", hintKey: "tracks.preserve.p_100_photos.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_first_video", titleKey: "tracks.preserve.p_first_video.title", descriptionKey: "tracks.preserve.p_first_video.desc", hintKey: "tracks.preserve.p_first_video.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_first_audio", titleKey: "tracks.preserve.p_first_audio.title", descriptionKey: "tracks.preserve.p_first_audio.desc", hintKey: "tracks.preserve.p_first_audio.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_3_rooms", titleKey: "tracks.preserve.p_3_rooms.title", descriptionKey: "tracks.preserve.p_3_rooms.desc", hintKey: "tracks.preserve.p_3_rooms.hint", pointValue: 10, navigateTo: "library" },
      { id: "p_mass_import", titleKey: "tracks.preserve.p_mass_import.title", descriptionKey: "tracks.preserve.p_mass_import.desc", hintKey: "tracks.preserve.p_mass_import.hint", pointValue: 10, navigateTo: "library-import" },
      { id: "p_10_descriptions", titleKey: "tracks.preserve.p_10_descriptions.title", descriptionKey: "tracks.preserve.p_10_descriptions.desc", hintKey: "tracks.preserve.p_10_descriptions.hint", pointValue: 10, navigateTo: "library" },
      { id: "p_5_locations", titleKey: "tracks.preserve.p_5_locations.title", descriptionKey: "tracks.preserve.p_5_locations.desc", hintKey: "tracks.preserve.p_5_locations.hint", pointValue: 10, navigateTo: "library" },
    ],
  },
  ...
  // ─── Track 2: Visualize & Publish Data (5.1.2) ───
  {
    ...
    steps: [
      ...
      { id: "v_reorder", titleKey: "tracks.visualize.v_reorder.title", descriptionKey: "tracks.visualize.v_reorder.desc", hintKey: "tracks.visualize.v_reorder.hint", pointValue: 10, navigateTo: "entrance" },
    ],
  },
  ...
  // ─── Track 3: Enhance Past Data (5.1.3) ───
  {
    ...
    steps: [
      { id: "e_long_desc", titleKey: "tracks.enhance.e_long_desc.title", descriptionKey: "tracks.enhance.e_long_desc.desc", hintKey: "tracks.enhance.e_long_desc.hint", pointValue: 10, navigateTo: "library" },
      { id: "e_voice_memo", titleKey: "tracks.enhance.e_voice_memo.title", descriptionKey: "tracks.enhance.e_voice_memo.desc", hintKey: "tracks.enhance.e_voice_memo.hint", pointValue: 10, navigateTo: "library" },
      { id: "e_journal", titleKey: "tracks.enhance.e_journal.title", descriptionKey: "tracks.enhance.e_journal.desc", hintKey: "tracks.enhance.e_journal.hint", pointValue: 10, navigateTo: "interview" },
      { id: "e_historical", titleKey: "tracks.enhance.e_historical.title", descriptionKey: "tracks.enhance.e_historical.desc", hintKey: "tracks.enhance.e_historical.hint", pointValue: 10, navigateTo: "library" },
      ...
      { id: "e_all_types", titleKey: "tracks.enhance.e_all_types.title", descriptionKey: "tracks.enhance.e_all_types.desc", hintKey: "tracks.enhance.e_all_types.hint", pointValue: 10, navigateTo: "library-import" },
    ],
  },
  ...
  // ─── Track 4: Make Future Resolutions (5.1.4) ───
  {
    ...
    steps: [
      { id: "r_first_capsule", titleKey: "tracks.resolutions.r_first_capsule.title", descriptionKey: "tracks.resolutions.r_first_capsule.desc", hintKey: "tracks.resolutions.r_first_capsule.hint", pointValue: 10, navigateTo: "library" },
      { id: "r_next_year", titleKey: "tracks.resolutions.r_next_year.title", descriptionKey: "tracks.resolutions.r_next_year.desc", hintKey: "tracks.resolutions.r_next_year.hint", pointValue: 10, navigateTo: "library" },
      { id: "r_5_years", titleKey: "tracks.resolutions.r_5_years.title", descriptionKey: "tracks.resolutions.r_5_years.desc", hintKey: "tracks.resolutions.r_5_years.hint", pointValue: 10, navigateTo: "library" },
      { id: "r_3_goals", titleKey: "tracks.resolutions.r_3_goals.title", descriptionKey: "tracks.resolutions.r_3_goals.desc", hintKey: "tracks.resolutions.r_3_goals.hint", pointValue: 10, navigateTo: "library" },
      { id: "r_future_letter", titleKey: "tracks.resolutions.r_future_letter.title", descriptionKey: "tracks.resolutions.r_future_letter.desc", hintKey: "tracks.resolutions.r_future_letter.hint", pointValue: 10, navigateTo: "library" },
    ],
  },
