...
const CLIPS = [
  ...
  },
  {
    ...
    tests: 'Relief hook aimed at the guilt of the unwritten memoir. Structure is a BEFORE/AFTER match cut on one camera pose.',
    carousel: 'organise',
    music: "light-in-dark-places.mp3", offset: 90, vol: 0.95,
    beats: [
      { kind: "card", png: G("LEGACY-10-hook"), secs: 3.2 },
      { kind: "beat", f: "room-tier1", secs: 3.4, from: 1.2, grade: "soft", xf: 0.5,
        cap: G("LEGACY-10-cap1"), capIn: 0.8, capOut: 2.8 },
      // Same pose, full. The argument is made by the CUT, not by a caption.
      { kind: "beat", f: "room-tier4", secs: 3.6, from: 1.2, grade: "soft", xf: 0.08,
        cap: G("LEGACY-10-cap2"), capIn: 0.8, capOut: 3.0 },
      { kind: "beat", f: "walk-roots-wall", secs: 3.4, from: 5.0, grade: "soft", xf: 0.5 },
